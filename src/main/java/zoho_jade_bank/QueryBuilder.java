...
public class QueryBuilder {
    ...
    static {
        try (InputStream inputStream = new FileInputStream("orm_mapping.yaml")) {
            Yaml yaml = new Yaml();
    ...
    public QueryResult build() throws IllegalAccessException {
...
//    
//    static {
//        try (InputStream inputStream = new FileInputStream("/home/sakthi-pt7767/eclipse-workspace/zoho_jade_bank/orm_mapping.yaml")) {
//        	Yaml yaml = new Yaml();
//			yamlMappings.putAll(yaml.load(inputStream));
//        } catch (Exception e) {
//            throw new RuntimeException("Error loading YAML: " + e.getMessage());
